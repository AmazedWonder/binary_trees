...
/**
 * is_avl_helper - Helper function to check if a binary tree
 * is a valid Adelson-Velsky and Landis(AVL) tree
 * @tree: A pointer to the binary tree node
 * @lo: The lower limit of the valid range
 * @hi: The upper limit of the valid range
 *
