...
/**
 * tree_size_h - calculates size (number of nodes) of a binary tree
 * @tree: Pointer to the root node of the binary tree
 *
...
/**
 * _preorder - performs a preorder traversal of a binary tree
 * @tree: Pointer to the root node of the binary tree
 * @node: Pointer to the node to be updated
 * @height: height at which to update node pointer
 */
...
/**
 * heapify - performs heapify operation on a binary heap
...
/**
 * heap_extract - function extracts the root element from
 * a binary heap
 * @root: Pointer to a pointer to the root node of the binary heap
 *
 * Return: The extracted value from the root of the binary heap
 */
