...
/**
 * create_tree - Constructs an AVL tree from a sorted array
 * @node: Pointer to the current node of the AVL tree
 * @array: Pointer to the sorted array
 * @size: The size of the array
 * @mode: The mode indicating whether the current
 * node is the left or right child
 */
